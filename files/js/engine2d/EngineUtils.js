...
/**
 * Utils class for the Engine2D
 *
 * @class      EngineUtils (name)
 * @return     {(Object|RegExp|boolean|string)}  { description_of_the_return_value }
 */
function EngineUtils() {
    ...
    /**
     * General check if the browser has all the features which are required by Engine2D.
     *
     * @return     {boolean}  Returns true if supported.
     */
    this.engineSupported = function() {
